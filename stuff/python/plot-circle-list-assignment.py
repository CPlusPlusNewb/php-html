...
def grid(t):
    ...
    specialstuff.text(-165, 410, 'Circle Circumference and Diameter Plot', '#00ff00', 25, 'underline bold', 'Verdana', 'left', t)
    specialstuff.text(-45, 10, 'C\ni\nr\nc\nu\nm\nf\ne\nr\ne\nn\nc\ne', '#00ff00', 18, 'bold', 'Verdana', 'left', t)
    specialstuff.text(200, -40, 'D i a m e t e r', '#00ff00', 18, 'bold', 'Verdana', 'center', t)
    t.hideturtle()
    t.penup()
