...
<style>
  .bruh {
    background: url('<?php $a = array('images/html.gif'); echo $a[array_rand($a)];?>');
...
<div id="navbar">
  ...
  <a class="tablinks" onclick="switchtabs(event, 'Html/Php')" id="defaultOpen">Html / Php</a>
...
<div id="Html/Php" class="tabcontent">
<p>Tab: html/php</p>
<section>
